...
Version 2.5.0 introduces controlled inventory storage, built-in methodological
validation, and structured audit reports. The main changes are:
...
and the [full 2.5.0 changelog](CHANGELOG.md#250) for details.
